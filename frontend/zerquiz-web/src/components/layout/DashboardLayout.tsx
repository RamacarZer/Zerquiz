...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        id: "royalty-employee",
        label: "İç Telif (Personel)",
        icon: "👥",
        path: "/royalty/employee",
      },
      {
        id: "royalty-external",
        label: "Dış Telif",
        icon: "🌐",
        path: "/royalty/external",
      },
      {
        id: "royalty-remote",
        label: "Uzaktan Çalışan",
        icon: "🏠",
        path: "/royalty/remote",
      },
      {
