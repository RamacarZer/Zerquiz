...
interface EducationModelCreateModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

const EducationModelCreateModal = ({
  isOpen,
  onClose,
  onSuccess,
}: EducationModelCreateModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.code.trim()) {
      setError("Model kodu zorunludur");
      setActiveTab("basic");
      return;
    }
    ...
    try {
      const model = await curriculumServiceEnhanced.createEducationModel(
        formData
      );
      ...
      setError(
        err.response?.data?.message ||
          "Eğitim modeli oluşturulurken bir hata oluştu"
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <Input
              label="Model Kodu"
              name="code"
              placeholder="TR_MEB, TR_TYT, OXFORD, CAMBRIDGE..."
              value={formData.code}
              onChange={(e) =>
            ...
            <Input
              label="Ülke"
              name="country"
              placeholder="Türkiye, İngiltere, ABD..."
          ...
          <Input
            label="Model Adı (Türkçe)"
            name="name"
            placeholder="MEB Müfredatı, TYT Müfredatı, Cambridge IGCSE..."
            value={formData.name}
          ...
          <Textarea
            ...
            name="description"
            rows={3}
            placeholder="Eğitim modeli açıklaması..."
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              ...
              Eğitim modelinin farklı dillerdeki karşılıklarını girin. Boş
              bırakılan alanlar kaydedilmez.
            </p>
          </div>
          ...
          <div className="border border-gray-200 rounded-lg p-4 space-y-3">
            ...
            <Input
              label="Name"
              placeholder="National Curriculum, Cambridge IGCSE..."
            ...
            <Textarea
              label="Description"
              rows={2}
              placeholder="Education model description..."
          ...
          <div className="border border-gray-200 rounded-lg p-4 space-y-3">
            ...
            <Input
              label="Name"
              placeholder="Nationaler Lehrplan..."
            ...
            <Textarea
              label="Beschreibung"
              rows={2}
              placeholder="Bildungsmodell Beschreibung..."
          ...
          <div className="border border-gray-200 rounded-lg p-4 space-y-3">
            ...
            <Input
              label="Nom"
              placeholder="Programme national..."
            ...
            <Textarea
              label="Description"
              rows={2}
              placeholder="Description du modèle éducatif..."
          ...
          <div className="border border-gray-200 rounded-lg p-4 space-y-3">
            ...
            <Textarea
              label="الوصف"
              rows={2}
              placeholder="وصف النموذج التعليمي..."
...
export default EducationModelCreateModal;
