    ...
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/questions" element={<DashboardLayout><QuestionListPage /></DashboardLayout>} />
          ...
          <Route path="/users/:id" element={<DashboardLayout><UserProfilePage /></DashboardLayout>} />
          <Route path="/users/roles" element={<DashboardLayout><RolesManagementPage /></DashboardLayout>} />
          <Route path="/users/departments" element={<DashboardLayout><DepartmentsManagementPage /></DashboardLayout>} />
          <Route path="/users/positions" element={<DashboardLayout><PositionsManagementPage /></DashboardLayout>} />
          <Route path="/tenants" element={<DashboardLayout><TenantManagementPage /></DashboardLayout>} />
          <Route path="/tenants/create" element={<DashboardLayout><TenantCreatePage /></DashboardLayout>} />
          <Route path="/tenants/:id" element={<DashboardLayout><TenantDetailPage /></DashboardLayout>} />
          <Route path="/tenants/:id/edit" element={<DashboardLayout><TenantEditPage /></DashboardLayout>} />
          <Route path="/licenses" element={<DashboardLayout><LicensePackagesPage /></DashboardLayout>} />
          <Route path="/curriculum" element={<DashboardLayout><CurriculumHubPage /></DashboardLayout>} />
          <Route
            path="/curriculum/education-models"
            element={<DashboardLayout><EducationModelManagementPage /></DashboardLayout>}
          />
          <Route
            path="/curriculum/subjects-manage"
            element={<DashboardLayout><SubjectManagementPage /></DashboardLayout>}
          />
          <Route path="/curriculum/topics" element={<DashboardLayout><TopicManagementPage /></DashboardLayout>} />
          <Route
            path="/curriculum/learning-outcomes"
            element={<DashboardLayout><LearningOutcomeManagementPage /></DashboardLayout>}
          />
          <Route path="/curriculum/subjects" element={<DashboardLayout><SubjectListPage /></DashboardLayout>} />
          <Route
            path="/grading"
            element={
              <DashboardLayout>
